...
class ListingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('listing.index', compact('listings', 'categories', 'sizes', 'colors', 'cities'));
    }
    ...
    public function create()
    {
        ...
        $sizes = Size::all();
        $colors = Color::all();
        return view('listing.create', compact('categories', 'sizes', 'colors'));
    }
    ...
    public function store(StoreListingRequest $request)
    {
        ...
        $listing->colors()->attach($request->color);
    ...
    public function edit(Listing $listing)
    {
        ...
        $sizes = Size::all();
        $colors = Color::all();
        return view('listing.edit', compact('listing', 'media', 'categories', 'sizes', 'colors'));
    }
