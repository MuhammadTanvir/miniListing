        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('listings.update', $listing) }}" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <x-jet-input id="title" class="block w-full mt-1" type="text" name="title" :value="$listing->title" />
                </div>

                <div class="mt-4">
                    <x-jet-label for="description" value="{{ __('Description') }}" />
                    <textarea id="price" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="description">{{ $listing->description }}</textarea>
                </div>

                <div class="mt-4">
                    <x-jet-label for="price" value="{{ __('Price') }}" />
                    <x-jet-input id="price" class="block w-full mt-1" type="text" name="price" :value="$listing->price" />
                </div>
